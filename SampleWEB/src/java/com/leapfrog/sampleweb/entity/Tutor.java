...
public class Tutor implements Serializable {
    ...
    public Tutor(Integer tutorId, String firstName, String lastName, String email, String contactNo, String address, Date addedDate, boolean status) {
        this.tutorId = tutorId;
    ...
    public String toString() {
        return "com.leapfrog.sampleweb.entity.Tutor[ tutorId=" + tutorId + " ]";
    }
